...
struct ChoiceListView: View {
    ...
    var body: some View {
        ...
        ForEach(choices) { choice in
            ChoiceLabelView(choiceInfo: choice, answer: question.answer, scoreIdx: scoreIdx, questionIdx: questionIdx, selectedNum: $selectedNum, showInfo: $showInfo)
...
struct ChoiceListView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ChoiceListView(question: question, scoreIdx: scoreIdx, questionIdx: questionIdx, showInfo: .constant(false))
            .environmentObject(quiz)
    }
}
